        ...
        <div class="top-inner clearfix">
            <div class="ta-partner-logo-wrapper top-inner-container">
                ...
                if (tolvignetten_print_has_logo()) {
                    ...
                    $defaultLogoUri = get_template_directory_uri() . '/../marketing-affiliate-child/img/' . $domain . '-logo.svg';
                    ?>
                    <a href="<?php echo esc_url(home_url('/')); ?>" class="logo">
                        <img src="<?php echo esc_url($defaultLogoUri); ?>" alt="<?php echo esc_attr(get_bloginfo( 'name' )); ?>"/>
                    </a>
                    <?php
                }
                ?>
